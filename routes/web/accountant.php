...
// ---------------------- Role: Accountant / Limited Access (role:3) ----------------------
Route::middleware(['auth', 'role:3', 'log.activity'])->group(function () {

    Route::get('/', [DashboardController::class, 'index'])->name('dashboard.index');
    //Route::get('/dashboardAC', [DashboardController::class, 'index'])->name('accountant.dashboard');
    ...
    // Subject routes
//    Route::get('/sidebar-classes', [SubjectController::class, 'getClassesWithSubjects']);
